...
<div>
  <a href="https://github.com/reservoir-data/tap-leaflink/blob/main/LICENSE">
    <img alt="License" src="https://img.shields.io/github/license/reservoir-data/tap-leaflink"/>
  </a>
...
Singer tap for the LeafLink Marketplace V2 API.
